...
4. **Tone and Style**: No emojis anywhere in the project (no UI output, no docs, no code). All text must be engaging and professional. Do not use generic "AI slop" language.
