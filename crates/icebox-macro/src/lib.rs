...
use syn::{
    parse_macro_input, parse_quote, Data, DeriveInput, Expr, ExprLit, Fields, Lit, Meta, Token,
};
...
pub fn module(attr: TokenStream, item: TokenStream) -> TokenStream {
    ...
    input.attrs.push(
        parse_quote!(#[derive(::core::default::Default, ::core::clone::Clone, ::core::fmt::Debug)]),
    );
