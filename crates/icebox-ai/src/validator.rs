...
use icebox_core::safety::{now_secs, RiskLevel};

use crate::agent::Planner;
use crate::orchestrator::{CampaignReport, Orchestrator};
...
mod tests {
    ...
    async fn validation_captures_policy_version_and_totals() {
        ...
        let report = run_validation(fw, &targets, RiskLevel::Critical, || Box::new(StaticPlanner::new())).await;
